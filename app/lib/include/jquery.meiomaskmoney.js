...
(function($){
	...
	$.extend({
		mask : {
			...
			options : {
				attr: 'msk', // an attr to look for the mask name or the mask itself
			...
			masks : {
				...
				'faltas'			: { mask : '999', type : 'reverse', defaultValue : '0' },
                                'media' 			: { mask : '99.999', type : 'reverse', defaultValue : '000' },
                                'ninteger'			: { mask : '9999', type : 'reverse', defaultValue : '' },
...
$(document).ready(function(){
    $('input:text').setMask();
    $(document).find("input.money").maskMoney();
    $(document).find("input.decimal").maskMoney({symbol: ""});
});